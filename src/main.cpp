...
int pumpPin = 13;
const long wateringInterval = 43200000; //how long to wait until checking whether or not to water (default 12 hours or 43,200,000 ms)
...
int lightPin = 10;
const long lightInterval = 86400000; // Period of the grow light cycle (default 24 hours or 86,400,000 ms)
const long lightActivationLength = 36000000; // how long to leave the light on per period (default 10 hours or 36,000,000 ms)
...
int fanPin = 9;
const long fanInterval = 7200000; // Period of the fan cycle (default 120 minutes or 7,200,000 ms)
const long fanActivationLength = 3600000; // how long to leave the fan on per period (default 60 minutes or 3,600,000 ms)
